...
public class StopPersistenceTest {
    ...
    void removingStopFromList_deletesOrphan_butPlaceSurvives() {
        ...
        // Place must NOT be deleted — it's shared/reusable, only the Stop was trip-specific
    ...
    void samePlace_reusedAcrossTwoTrips() {
        ...
        assertThat(placeRepository.findAll())
                ...
                .hasSize(1); // only ONE Place row despite two trips using it
    }
}
